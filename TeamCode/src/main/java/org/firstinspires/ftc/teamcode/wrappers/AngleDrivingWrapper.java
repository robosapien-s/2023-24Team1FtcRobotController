...
public class AngleDrivingWrapper{
    ...
    public AngleDrivingWrapper(HardwareMap inHardwareMap, Telemetry inTelemetry, double Kp, double Ki, double Kd, double maxIntegralSum, double a) {
        ...
        anglePID = new PIDController(Kp, Ki, Kd, maxIntegralSum, a);
    ...
    public void Drive(RevIMUv2 revIMU, JoystickWrapper joystickWrapper, double speed, double rotSpeed) {
        ...
        double angleCorrection = anglePID.calculatewitherror(angleError, dt);

        double t = -angle + angleCorrection; // how to make this into a -1 to 1 power
