...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(5.5, 0,0.2); //10,0,1
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(7, 0, 0); //8,0,0

    public static double LATERAL_MULTIPLIER = 1.5789473684*1.1538461538*1.03806228374;
