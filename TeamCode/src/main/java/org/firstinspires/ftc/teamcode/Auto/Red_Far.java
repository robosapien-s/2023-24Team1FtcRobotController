...
public class Red_Far extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence trajectory1 = drive.trajectorySequenceBuilder(new Pose2d(-36, -62, Math.toRadians(-90)))
            .setReversed(true)
            ...
            .build();
        TrajectorySequence trajectory2 = drive.trajectorySequenceBuilder(new Pose2d(-36, -62, Math.toRadians(-90)))
            ...
            .lineToLinearHeading(new Pose2d(60,-12, Math.toRadians(0)))
            .build();
        TrajectorySequence trajectory3 = drive.trajectorySequenceBuilder(new Pose2d(-36, -62, Math.toRadians(-90)))
            .setReversed(true)
