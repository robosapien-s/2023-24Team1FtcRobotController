...
public class Blue_Far_Wall extends BaseAutoOp {
    ...
    public TrajectorySequence buildTragectory1() {
        ...
        */
        ...
        dropPurplePixelFar(trajectory2SequenceBuilder1,
                new Vector2d(Blue_Far_Wall.T1_purplePixelLocation_x, Blue_Far_Wall.T1_purplePixelLocation_y), Math.toRadians(Blue_Far_Wall.T1_purplePixelLocation_heading));

        lineUpForSinglePixelFarBackBoard(trajectory2SequenceBuilder1,
                new Vector2d(Blue_Far_Wall.T1_lineUpSingleWhite_x, Blue_Far_Wall.T1_lineUpSingleWhite_y), Math.toRadians(Blue_Far_Wall.T1_lineUpSingleWhite_heading));
    ...
    public TrajectorySequence buildTragectory2() {
        ...
        getArmReady(trajectory2SequenceBuilder1);
         dropPurplePixelFar(trajectory2SequenceBuilder1,
                new Vector2d(Blue_Far_Wall.T2_purplePixelLocation_x, Blue_Far_Wall.T2_purplePixelLocation_y), Math.toRadians(Blue_Far_Wall.T2_purplePixelLocation_heading));

         lineUpForSinglePixelMiddle(trajectory2SequenceBuilder1,
                new Vector2d(Blue_Far_Wall.T2_lineUpSingleWhite_x, Blue_Far_Wall.T2_lineUpSingleWhite_y), Math.toRadians(Blue_Far_Wall.T2_lineUpSingleWhite_heading));
    ...
    public TrajectorySequence buildTragectory3() {
        ...
        dropPurplePixelFar(trajectory2SequenceBuilder3,
                new Vector2d(Blue_Far_Wall.T3_purplePixelLocation_x, Blue_Far_Wall.T3_purplePixelLocation_y), Math.toRadians(Blue_Far_Wall.T3_purplePixelLocation_heading));

        lineUpForSinglePixel(trajectory2SequenceBuilder3,
                new Vector2d(Blue_Far_Wall.T3_lineUpSingleWhite_x, Blue_Far_Wall.T3_lineUpSingleWhite_y), Math.toRadians(Blue_Far_Wall.T3_lineUpSingleWhite_heading));
