...
public class Blue_Close extends BaseAutoOp {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        dropOffWhitePixels(trajectory2SequenceBuilder1,
                ...
                new Vector2d(T1_dropWhite_x, T1_dropWhite_y), Math.toRadians(T1_dropWhite_heading), 500, 1000
        );
...
//                .build();
       ...
       performYellowPixelDrop(trajectory2SequenceBuilder,
        ...
        trajectory2 = dropOffWhitePixels(trajectory2SequenceBuilder,
                ...
                new Vector2d(T2_dropWhite_x, T2_dropWhite_y), Math.toRadians(T2_dropWhite_heading), 500, 1200).build();
